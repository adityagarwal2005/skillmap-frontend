/* The skill taxonomy behind the feed's "Browse by skill" rail, the
   create-post suggestions and onboarding. Mirrors
   skills/management/commands/seed_categories.py: `backend` is that
   category's name there and `skills` its starter skills, while `terms`
   adds the everyday words people actually write in a post. A listing can
...
export const SKILL_CATEGORIES = [
  {
    ...
    backend: 'Code / Software',
    skills: ['Python', 'JavaScript', 'React', 'Node.js', 'Java', 'C++', 'Flutter', 'Android', 'Machine Learning', 'Web Development'],
  ...
  },
  {
    ...
    backend: 'Design & Media',
    skills: ['UI/UX', 'Figma', 'Graphic Design', 'Logo Design', 'Poster Design', 'Canva', 'Illustration'],
  ...
  },
  {
    ...
    backend: 'Photography & Video',
    skills: ['Photography', 'Video Editing', 'Reels', 'Event Coverage', 'Portrait', 'Premiere Pro', 'Photoshop'],
  ...
  },
  {
    ...
    backend: 'Content & Writing',
    skills: ['Blog Writing', 'Technical Writing', 'Copywriting', 'Resume Writing', 'Editing', 'Scriptwriting'],
  ...
  },
  {
    ...
    backend: 'Business & Marketing',
    skills: ['Social Media', 'Digital Marketing', 'SEO', 'Branding', 'Sales', 'Public Speaking'],
  ...
  },
  {
    ...
    skills: ['Event Planning', 'Anchoring', 'Volunteering', 'Sponsorship', 'Logistics', 'Hosting'],
  ...
  },
  {
    ...
    backend: 'Tutoring & Academics',
    skills: ['Maths', 'Physics', 'Chemistry', 'Coding Help', 'Doubt Solving', 'Subject Tutoring'],
  ...
  },
  {
    ...
    backend: 'Notes & Study Material',
    skills: ['Handwritten Notes', 'Assignment Help', 'Exam Prep', 'Lab Records', 'Presentations', 'Research Papers'],
  ...
  },
  {
    ...
    backend: 'Music & Performance',
    skills: ['Singing', 'Guitar', 'Keyboard', 'Dance', 'DJ', 'Music Production'],
  ...
  },
  {
    ...
    skills: ['Arduino', 'Raspberry Pi', 'Embedded C', 'PCB Design', 'Robotics', 'Sensors', 'ESP32', '3D Printing'],
  ...
  },
  {
    ...
    backend: 'Art & Craft',
    skills: ['Painting', 'Sketching', 'Handmade Crafts', 'Calligraphy', 'Resin Art', 'Origami'],
  ...
  },
  {
    ...
    backend: 'Sports & Fitness',
    skills: ['Gym Training', 'Cricket', 'Football', 'Yoga', 'Athletics', 'Nutrition'],
  ...
  },
  {
    ...
    backend: 'Gaming & Esports',
    skills: ['Game Development', 'Streaming', 'Esports', 'Unity', 'Level Design', 'Game Art'],
...
export const categoryByBackendName = (name) =>
  SKILL_CATEGORIES.find(c => c.backend === name) || null;
