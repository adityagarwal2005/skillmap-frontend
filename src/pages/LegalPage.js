...
function TermsContent() {
  return (
    <>
      ...
      <p>
        SkillMap ("we", "us", "the platform") is a campus talent network that helps students
        find skilled people nearby, post and apply to freelance work, and team up on collabs.
        By creating an account you agree to these terms.
      </p>

      <h2>1. Who can use SkillMap</h2>
      <p>
        SkillMap is built for students on our campus. You must provide accurate information when
      ...
      <h2>2. SkillMap is a connector, not a party to your agreements</h2>
      <p>
        <strong>SkillMap does not process, hold, or guarantee any payment.</strong> Freelance jobs,
        collabs, and any pay you arrange with another user are agreements directly between you and
        them — SkillMap has no part in that transaction, doesn't verify anyone's ability to pay or
      ...
      <p>
        Nothing on SkillMap creates an employment relationship between you, SkillMap, or anyone you
      ...
      <p>
        ...
        videos, and messages. By posting, you give SkillMap permission to store and display it to
      ...
      <p>
        ...
        any profile or post if someone violates this — reports are reviewed by the SkillMap team.
      </p>
      ...
      <h2>7. Changes</h2>
      <p>
        We may update these terms as SkillMap evolves. Material changes will be reflected here with
        an updated date.
      </p>

      <h2>8. Contact</h2>
      <p>Questions about these terms? Reach out to the SkillMap team through the app.</p>
    </>
  );
}
...
function PrivacyContent() {
  return (
    <>
      ...
      <p>
        This explains what SkillMap collects, why, and how it's used. We collect the minimum
      ...
      <p>
        We use a small number of infrastructure providers to run SkillMap: a hosting provider for
      ...
      <h2>7. Changes</h2>
      <p>We may update this policy as SkillMap evolves. Material changes will be reflected here.</p>

      <h2>8. Contact</h2>
      <p>Questions about your data? Reach out to the SkillMap team through the app.</p>
    </>
  );
}
